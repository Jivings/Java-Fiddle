  ...
  worker.onmessage = function(e) {
    ...
    actions = {
      'new': function(data) {
        ...
        if (data.locals) theThread.current_frame.locals = data.locals;
  ...
  this.Thread = (function() {
    ...
    Thread.prototype.reportObjects = function() {
      ...
      for (index in this.jvm_stack) {
        ...
        for (index in frame.op_stack) {
          ...
          if (item.pointer) objs.push(item);
        }
    ...
    Thread.prototype.start = function(destroy) {
      ...
      while (this.current_frame != null) {
        if (this.current_frame.execute(this.opcodes, this)) {
          if (this.current_frame) this.log(this.current_frame.locals);
          continue;
        } else {
          return false;
        }
    ...
    */
    ...
    Thread.prototype.resolveClass = function(clsname, callback, caller) {
      ...
      if (typeof clsname === 'object') {
        ...
        if (this.callback === cb) this.callback = null;
        return;
      }
    ...
    */
    ...
    Thread.prototype.resolveMethod = function(methodname, classname, descriptor, callback, caller) {
      this.callback = callback;
      this.caller = caller;
      if (classname.real_name) classname = classname.real_name;
      return worker.postMessage({
    ...
    */
    ...
    Thread.prototype.getStatic = function(classname, fieldname, callback, caller) {
      this.callback = callback;
      this.caller = caller;
      if (typeof classname === 'object') classname = classname.real_name;
      return worker.postMessage({
        'action': 'getStatic',
        'classname': classname,
        'fieldname': fieldname
    ...
    */
    ...
    Thread.prototype.setStatic = function(classname, fieldname, value) {
      ...
      if (classname.real_name != null) classname = classname.real_name;
      return worker.postMessage({
        'action': 'setStatic',
        'classname': classname,
        'fieldname': fieldname,
